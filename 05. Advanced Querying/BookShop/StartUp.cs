namespace BookShop
{
    ...
    public class StartUp
    {
        ...
        // Problem 12
        // In some copies, where complex queries are performed,
        // we cam materialize the query at some point and the other logic to be executed in program memory
        ...
        public static void IncreasePrices(BookShopContext context)
        {
            ...
            // foreach will trigger the SQL Query execution of the query built up-tho here
